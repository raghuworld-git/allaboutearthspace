...
const LaunchCard = ({ imgURL, id, net, name, launchLocation, launchStatus, additionalqueryParams = null, footer = null }) => {
        ...
        <>
            <MDBCard style={{
                ...
                <MDBCardBody className={`text-center rgba-black-light ${styles.launchCard_body}`}>
                    ...
                    <Link to={`/launchDetails/${id}/${name}${addiQueryParams}`} className="btn  btn-sm btn-primary mt-2">For more</Link>
                </MDBCardBody>
                {footer ?
                    footer
                    : null
